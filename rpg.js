const fs = require('fs')
const uang = JSON.parse(fs.readFileSync('./user/uang.json'))
const ikan = JSON.parse(fs.readFileSync('./user/ikan.json'))
const planet = JSON.parse(fs.readFileSync('./user/planet.json'))
const coal = JSON.parse(fs.readFileSync('./user/coal.json'))
const stone = JSON.parse(fs.readFileSync('./user/stone.json'))
const ore = JSON.parse(fs.readFileSync('./user/ore.json'))
const ingot = JSON.parse(fs.readFileSync('./user/ingot.json'))
const kayu = JSON.parse(fs.readFileSync('./user/kayu.json'))
const _level = JSON.parse(fs.readFileSync('./user/level.json'))
let besiAwal = 15;
  let goldAwal = 10;
  let emeraldAwal = 5;
  let umpanAwal = 5;
...
let _RPG = JSON.parse(fs.readFileSync('./user/inventory.json'))
...
const addLevelingXp = (sender, amount) => {
	...
	if (position !== false) {
		...
		fs.writeFileSync('./user/level.json', JSON.stringify(_level))
	}
}
...
const addATM = (sender) => {
	...
	uang.push(objo)
	fs.writeFileSync('./user/uang.json', JSON.stringify(uang))
}
...
const addIkan = (sender, amount) => {
    	...
    	fs.writeFileSync('./user/ikan.json', JSON.stringify(ikan))
    	}
    }
...
const addPlanet = (sender, amount) => {
    	...
    	fs.writeFileSync('./user/planet.json', JSON.stringify(planet))
    	}
    }
...
const jualbahankimia = (sender, amount) => {
 ...
 const addCoal = (sender, amount) => {
    	...
    	fs.writeFileSync('./user/coal.json', JSON.stringify(coal))
    	}
    }
...
const addStone = (sender, amount) => {
    	...
    	fs.writeFileSync('./user/stone.json', JSON.stringify(stone))
    	}
    }
...
const addOre = (sender, amount) => {
    	...
    	fs.writeFileSync('./user/ore.json', JSON.stringify(ore))
    	}
    }
...
const jualore = (sender, amount) => {
        ...
        if (position !== false) {
            ore[position].copperore -= amount
            fs.writeFileSync('./user/ingot.json', JSON.stringify(ingot))
        }
    }
...
const addKayu = (sender, amount) => {
    	...
    	fs.writeFileSync('./user/kayu.json', JSON.stringify(kayu))
    	}
    }
...
const addInventori = (sender) => {
            ...
            _RPG.push(obj)
            fs.writeFileSync('./user/inventory.json', JSON.stringify(_RPG))
        } 
